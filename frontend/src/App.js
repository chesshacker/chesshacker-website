...
import { Grid, Navbar, Row, Col, Image } from 'react-bootstrap';
        ...
        <Grid>
          <Row>
            ...
            <Col md={6}>
              ...
              <p>Justification:<br />
              Steve Ortiz identified a potential workaround to the... (potentially catastostrphic issue and summary of the solution). This new workaround has been accepted by NAVAIR as a path for returning to flight.</p>
              <p>Although Steve has already made significant contributions to Triton, this time his discovery is allowing us to continue envelope expansion at a critical time in our program (OTB/OTS). I suspect he has saved the program a significant amount of money.</p>
